...
const state = {
  ...
  appointments: {
    ...
    "3": {
      id: 3,
      time: "2pm",
      interview: { student: "Archie Cohen", interviewer: 2 } // Tori
    },
    // Tuesday
    ...
    "5": {
      id: 5,
      time: "4pm",
      interview: { student: "Chad Takahashi", interviewer: 2 } // Tori
    }
  },
  interviewers: {
    "1": {  
...
describe("getAppointmentForDay tests", () => {
...
describe("getInterviewersForDaytests tests", () => {
